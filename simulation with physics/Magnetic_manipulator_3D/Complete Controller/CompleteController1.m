...
MaxI=10; %Maximum current in the coils (saturation value)

Kp=1; %Proportional component of trajectory pid
...
if V(1) ==0 && V(2)==0 && V(3)==0
    [I,ActOut]=InverseMagnetics(TotalForce,Orien,P,coil_radius,MagneticMoment,T,MaxI,NbTurns,IPrevious);
else
    [I,ActOut]=InverseMagnetics(TotalForce,V./norm(V),P,coil_radius,MagneticMoment,T,MaxI,NbTurns,IPrevious);
